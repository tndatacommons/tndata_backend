...
class TestInterestListView(TestCase):
    ...
    def test_get(self):
        url = reverse("goals:interest-list")
        resp = self.client.get(url)
        self.assertEqual(resp.status_code, 200)
        self.assertTemplateUsed(resp, "goals/interest_list.html")
        self.assertIn("interests", resp.context)

        resp = self.ua_client.get(url)
        self.assertEqual(resp.status_code, 302)


class TestInterestDetailView(TestCase):
    ...
    def test_get(self):
        url = self.interest.get_absolute_url()
        resp = self.client.get(url)
        self.assertEqual(resp.status_code, 200)
        self.assertTemplateUsed(resp, "goals/interest_detail.html")
        self.assertContains(resp, self.interest.name)
        self.assertIn("interest", resp.context)

        resp = self.ua_client.get(url)
        self.assertEqual(resp.status_code, 302)


class TestInterestCreateView(TestCase):
    ...
    def test_get(self):
        url = reverse("goals:interest-create")
        ...
        resp = self.client.get(url)
        self.assertEqual(resp.status_code, 200)
        self.assertTemplateUsed(resp, "goals/interest_form.html")
        self.assertContains(resp, self.interest.name)
        self.assertIn("interests", resp.context)


class TestInterestUpdateView(TestCase):
    ...
    def test_get(self):
        url = self.interest.get_update_url()
...
class TestInterestDeleteView(TestCase):
    ...
    def test_get(self):
        url = self.interest.get_delete_url()
        resp = self.ua_client.get(url)
        self.assertEqual(resp.status_code, 302)

        resp = self.client.get(url)
        self.assertEqual(resp.status_code, 200)
        self.assertTemplateUsed(resp, "goals/interest_confirm_delete.html")
        self.assertIn("interest", resp.context)
