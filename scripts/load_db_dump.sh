...
elif [ -e "/Users/brad/tndata/deployment_tools/dump.sql" ]
    then
    dropdb tndata_backend;
    createdb -E UTF8 -T template0 tndata_backend
    psql -h 127.0.0.1 -d tndata_backend -f /Users/brad/tndata/deployment_tools/dump.sql
else
    echo
